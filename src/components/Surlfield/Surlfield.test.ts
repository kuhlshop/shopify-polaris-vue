...
describe("Surlfield", () => {
  ...
  it("passes defaultValue prop to the web component", async () => {
    const wrapper = mount(Surlfield, {
      props: {
        defaultValue: "https://shopify.com"
      }
    });
    
    const webComponent = wrapper.find("s-urlfield");
    expect(webComponent.attributes("default-value")).toBe("https://shopify.com");
  });
  ...
  it("passes id prop to the web component", async () => {
    ...
    const webComponent = wrapper.find("s-urlfield");
    expect(webComponent.attributes("id")).toBe("url-input");
  });
  ...
  it("passes name prop to the web component", async () => {
    ...
    const webComponent = wrapper.find("s-urlfield");
    expect(webComponent.attributes("name")).toBe("website");
  });
